                ...
                Row(
                  children: [
                    Expanded(
                      child: TileWidget(
                        subTitle:
                            authView.vendorModel!.security.toStringAsFixed(2),
                        title: "Security",
                      ),
                    ),
                    Expanded(
                      child: TileWidget(
                        subTitle: authView.vendorModel!.accessibility
                            .toStringAsFixed(2),
                        title: "Accessibility",
                      ),
                    ),
                    Expanded(
                      child: TileWidget(
                        subTitle: authView.vendorModel!.serviceQuality
                            .toStringAsFixed(2),
                        title: "Service",
                      ),
                    ),
                                ...
                                DialogButton(
                                  onPressed: () async {
                                    if (myController.text.isNotEmpty) {
                                      if (double.parse(myController.text) !=
                                          0) {
                                        authView.setHourlyPrice(
                              ...
                              content: Column(
                                children: <Widget>[
                                  TextField(
                                    ...
                                    textAlign: TextAlign.center,
                                    decoration: InputDecoration(
                                      hintText: authView.vendorModel!.startPrice
                                          .toString(),
                                      fillColor: Colors.white,
                                      filled: true,
                                      border: OutlineInputBorder(
